...
import { Video, Search, Play, Calendar, Clock, Youtube, ExternalLink, Trash2 } from 'lucide-react';
import Cookies from 'js-cookie';
import { toast } from 'sonner';
import Image from 'next/image';

export default function TeacherVideoaulasPage() {
    ...
    const handleDeleteVideo = async (videoId) => {
        try {
            ...
            if (!response.ok) {
                throw new Error('Erro ao deletar videoaula');
            }
            ...
            toast.success('Videoaula deletada com sucesso!');
        } catch (error) {
            console.error('Erro ao deletar videoaula:', error);
            toast.error('Erro ao deletar videoaula');
        }
    };
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col items-center mb-8 bg-white rounded-xl shadow-lg p-8 border border-gray-100">
                    ...
                    <p className="text-gray-600 text-center max-w-2xl">
                        Gerencie suas videoaulas e acompanhe o desempenho dos alunos
                    </p>
                </div>
                        ...
                        {selectedVideo ? (
                            ...
                            <div className="h-full flex items-center justify-center bg-white rounded-lg shadow-sm border border-gray-100 p-8">
                                <div className="text-center">
                                    ...
                                    <p className="text-gray-500">Escolha uma videoaula da lista para visualizar</p>
                                </div>
                            </div>
                        )}
                    </div>
